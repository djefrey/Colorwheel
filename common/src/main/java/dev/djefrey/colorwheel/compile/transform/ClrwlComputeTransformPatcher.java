...
public class ClrwlComputeTransformPatcher
{
    ...
    static
    {
        transformer = new ClrwlASTTransformer<>()
        {
            ...
            {
                transformer.getLexer().version = Version.fromNumber(GlCompat.MAX_GLSL_VERSION.version);
    ...
    public static String patchCompute(String shader, int ssboOffset, Object2ObjectMap<Tri<String, TextureType, TextureStage>, String> textureMap)
    {
        var parameters = new ClrwlTransformParameters(PatchShaderType.COMPUTE, false, false, ssboOffset, textureMap);

        return transformer.transform(shader, parameters).code();
    }
}
