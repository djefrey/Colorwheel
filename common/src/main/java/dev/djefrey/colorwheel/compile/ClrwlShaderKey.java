                             ...
                             ClrwlPipelineCompiler.OitMode oit)
{
    ...
    {
        var instanceName = IdentifierUtil.toDebugFileNameNoExtension(instanceType.vertexShader());
        var materialName = IdentifierUtil.toDebugFileNameNoExtension(material.vertexSource());
