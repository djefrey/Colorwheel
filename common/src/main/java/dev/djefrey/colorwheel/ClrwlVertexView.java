...
public class ClrwlVertexView extends AbstractVertexView {
	...
	public float tangentX(int index) {
		return DataPacker.unpackNormI8(MemoryUtil.memGetByte(ptr + index * STRIDE + 35));
	}

	public float tangentY(int index) {
		return DataPacker.unpackNormI8(MemoryUtil.memGetByte(ptr + index * STRIDE + 36));
	}

	public float tangentZ(int index) {
		return DataPacker.unpackNormI8(MemoryUtil.memGetByte(ptr + index * STRIDE + 37));
	}
	...
	public float midV(int index) {
		return MemoryUtil.memGetFloat(MemoryUtil.memGetByte(ptr + index * STRIDE + 43));
	}
	...
	@Override
	public void normalX(int index, float normalX) { MemoryUtil.memPutByte(ptr + index * STRIDE + 32, DataPacker.packNormI8(normalX)); }

	@Override
	public void normalY(int index, float normalY) { MemoryUtil.memPutByte(ptr + index * STRIDE + 33, DataPacker.packNormI8(normalY)); }

	@Override
	public void normalZ(int index, float normalZ) { MemoryUtil.memPutByte(ptr + index * STRIDE + 34, DataPacker.packNormI8(normalZ)); }

	public void tangentX(int index, float tangentX) { MemoryUtil.memPutByte(ptr + index * STRIDE + 35, DataPacker.packNormI8(tangentX)); }

	public void tangentY(int index, float tangentY) { MemoryUtil.memPutByte(ptr + index * STRIDE + 36, DataPacker.packNormI8(tangentY)); }
	...
	public void midV(int index, float midV) { MemoryUtil.memPutFloat(ptr + index * STRIDE + 43, midV); }
}
