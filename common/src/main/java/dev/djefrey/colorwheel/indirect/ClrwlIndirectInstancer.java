...
public class ClrwlIndirectInstancer<I extends Instance> extends ClrwlAbstractInstancer<I>
{
	private final long instanceStride;
	private final InstanceWriter<I> writer;
	private final List<ClrwlIndirectDraw> associatedDraws = new ArrayList<>();
	...
	@SuppressWarnings("unchecked")
	private static <I extends Instance> ClrwlInstanceHandle<I>[] handleArray()
	{
		return new ClrwlInstanceHandle[ObjectStorage.PAGE_SIZE];
	}

	@Nullable
	public static ClrwlIndirectInstancer<?> fromState(ClrwlInstanceHandle.State<?> handle)
	{
	...
	private static final class InstancePage<I extends Instance> implements ClrwlInstanceHandle.State<I>
	{
		private final ClrwlIndirectInstancer<I> parent;
		private final int pageNo;
		private final I[] instances;
		// Handles are only read in #takeFrom. It would be nice to avoid tracking these at all.
		private final ClrwlInstanceHandle<I>[] handles;
		/**
		...
		private InstancePage(ClrwlIndirectInstancer<I> parent, int pageNo)
		{
			this.parent = parent;
			this.pageNo = pageNo;
		 ...
		 */
		public boolean add(I instance, ClrwlInstanceHandle<I> handle)
		{
		...
		public ClrwlInstanceHandle.State<I> setVisible(ClrwlInstanceHandle<I> handle, int index, boolean visible)
		{
			...
			return new ClrwlInstanceHandle.Hidden<>(parent.recreate, out);
		}
	...
	public void addDraw(ClrwlIndirectDraw draw)
	{
		associatedDraws.add(draw);
	}

	public List<ClrwlIndirectDraw> draws()
	{
	...
	public void delete()
	{
		for (ClrwlIndirectDraw draw : draws())
		{
			draw.delete();
		}
	...
	{
		var handle = new ClrwlInstanceHandle<I>(null);
	...
	private void addInner(I instance, ClrwlInstanceHandle<I> handle)
	{
		// Outer loop:
