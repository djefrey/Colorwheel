...
public class ClrwlLightBuffers
{
	...
	public void bind()
	{
		...
		GL46.glBindBufferRange(GL46.GL_SHADER_STORAGE_BUFFER, ClrwlBufferBindings.LIGHT_LUT, lut.handle(), 0, lut.byteCapacity());
		GL46.glBindBufferRange(GL46.GL_SHADER_STORAGE_BUFFER, ClrwlBufferBindings.LIGHT_SECTION, sections.handle(), 0, sections.byteCapacity());
	}
