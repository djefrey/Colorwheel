...
public class ClrwlDepthPyramid
{
	...
	public ClrwlDepthPyramid(ClrwlProgramGroup programGroup, ClrwlIndirectPrograms programs, IrisRenderingPipeline irisPipeline)
	{
